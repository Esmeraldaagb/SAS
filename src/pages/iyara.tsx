...
import { Truck, Ship, Package, ExternalLink } from 'lucide-react';
...
const Iyara: React.FC = () => {
  ...
  const services: Service[] = [
    {
      icon: <Truck className="h-5 w-5 text-[#D39E00]" />,
    ...
    {
      icon: <Package className="h-5 w-5 text-[#D39E00]" />,
  ...
  return (
    <section id="transport" className="lg:px-20 px-2 py-20 bg-gray-50">
        ...
        <AnimatedSection animation="fade-up">
          ...
          <div className="mb-16 flex items-center justify-center">
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <AnimatedSection animation="fade-up">
                  <Card key={index} className="p-2 hover:shadow-lg transition-all duration-300">
